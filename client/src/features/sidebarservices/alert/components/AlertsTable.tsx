...
export default function AlertsTable({ alerts }: Props) {
  return (
    <div className="rounded-2xl p-6">
      ...
      <p className="text-gray-600 mb-6">Manage and prioritize suspicious activity alerts for review and investigation.</p>

      {/* Filters & Search */}
      <div className="flex flex-wrap justify-between items-end gap-6 mb-6 p-4 rounded-xl">
        ...
        <div className="flex items-center gap-3">
        <div>
        <h3 className="ml-2 mb-1 text-sm font-medium text-gray-700">Risk Level</h3>
        ...
        <div>
        <h3 className="text-sm font-medium text-gray-700 ml-2 mb-1">Date Range</h3>
        <select className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div>
        <h3 className="text-sm font-medium text-gray-700 ml-2 mb-1">Alert Type</h3>
        <select className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
          <option>All</option>
      ...
      {/* Pagination */}
      {alerts.length > 0 && (
        <div className="flex items-center justify-between px-4 sm:px-6 bg-gray-100 py-3 rounded-b-xl border border-gray-200">
